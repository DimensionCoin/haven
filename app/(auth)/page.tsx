    ...
    <main className="min-h-[100svh] bg-black text-white relative">
      ...
      <section className="container mx-auto max-w-6xl px-6 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-4 text-xs text-white/50">
            FDIC insured up to $250,000 • DeFi yields up to 8% APY
          </p>
        </div>
      ...
      <section className="container mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="w-12 h-12 rounded-full bg-blue-500/20 border border-blue-500/30 mx-auto mb-4 flex items-center justify-center">
              <div className="w-6 h-6 bg-blue-400 rounded"></div>
            </div>
            <h3 className="font-semibold mb-2">FDIC Insured</h3>
            <p className="text-sm text-white/70">
              Your deposits are protected up to $250,000 with traditional
              banking security
            </p>
          </div>
